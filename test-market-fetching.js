// Test script to verify market fetching improvements
const { polymarketAPI } = require('./lib/api/polymarket.ts');
...
async function testMarketFetching() {
  try {
    ...
    markets.forEach((market, index) => {
      const prices = require('./lib/api/polymarket').parseOutcomePrices(market.outcomePrices);
